...
#MAIN
dev = Label(janela, font = ('Palatino Linotype', 9), bg = 'red', text = 'Desenvolvido por: Emerson Dantas. GitHub: emersondantas Email: emerson.ruan@dce.ufpb.br   ')
dev.place(x = 0, y = 251)
